...
public class Drivebase extends SubsystemBase {
  ...
  RelativeEncoder m_leftEncoder = m_leftMaster.getAlternateEncoder(Type.kQuadrature, 4048);
  RelativeEncoder m_rightEncoder = m_rightMaster.getAlternateEncoder(Type.kQuadrature, 4048);
  ...
  public double getLeftDistanceInch(){
    return (m_leftEncoder.getPosition()/4048 * diameter * Math.PI);
  }

  public double getRightDistanceInch(){
    return (m_rightEncoder.getPosition()/4048 * diameter * Math.PI);
  }
