...
public class Drivebase extends SubsystemBase {
  ...
  public Drivebase() {
       ...
       MotorControllerGroup rightGroup = new MotorControllerGroup(m_rightMaster, m_rightSlave);
       MotorControllerGroup leftGroup = new MotorControllerGroup(m_leftMaster, m_leftSlave);
